...
==== 스터디 모임 조회 API
===== 요청
include::{snippets}/gathering/find/http-request.adoc[]
====== Header
include::{snippets}/gathering/find/request-headers.adoc[]
====== Path
include::{snippets}/gathering/find/path-parameters.adoc[]
====== Param
include::{snippets}/gathering/find/request-parameters.adoc[]
===== 응답
include::{snippets}/gathering/find/http-response.adoc[]
====== Body
include::{snippets}/gathering/find/response-fields.adoc[]
