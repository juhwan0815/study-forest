...
public class GatheringFixture {
    ...
    public static LocalDateTime TEST_LOCAL_DATE_TIME = LocalDateTime.of(2021,7,16,17,00);
    ...
    public static GatheringCreateRequest TEST_GATHERING_CREATE_REQUEST1
            = new GatheringCreateRequest(TEST_LOCAL_DATE_TIME, Shape.ONLINE,"테스트 모임",null,null,null);

    public static GatheringCreateRequest TEST_GATHERING_CREATE_REQUEST2
            = new GatheringCreateRequest(TEST_LOCAL_DATE_TIME, Shape.OFFLINE,"테스트 모임","테스트 장소",37.584009,126.970626);

    public static GatheringResponse TEST_GATHERING_RESPONSE1
            = new GatheringResponse(1L,1L,TEST_LOCAL_DATE_TIME,1,Shape.ONLINE,"테스트 모임",null,null);

    public static GatheringResponse TEST_GATHERING_RESPONSE2
            = new GatheringResponse(2L,1L,TEST_LOCAL_DATE_TIME,1,Shape.OFFLINE,"테스트 모임",TEST_PLACE,null);

    public static Gathering createOnlineGathering(){
        Gathering gathering = new Gathering(1L, 1L, TEST_LOCAL_DATE_TIME, Shape.ONLINE, "테스트 모임",
    ...
    public static Gathering createOfflineGathering(){
        ...
        Gathering gathering = new Gathering(1L, 1L, TEST_LOCAL_DATE_TIME, Shape.OFFLINE, "테스트 모임",
